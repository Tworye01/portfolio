  ...
  return (
    <main className="fixed inset-0 h-screen flex">
       <div className="absolute top-0 -z-10 h-full w-full bg-cream-100">
          <div className="absolute top-1/2 left-1/2 h-[800px] w-[1700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-darkgreen-100 opacity-20 blur-[80px] transform "></div>
