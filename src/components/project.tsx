...
export const ProjectCardComponent: React.FC<ProjectCardProps> = ({ image, title, description, link }) => {
  return (
    <a
      ...
      className="w-72 md:w-80 outline outline-5 h-auto overflow-hidden outline-darkgreen-100
       bg-cream-100 rounded-lg shadow-xl transition-transform transform hover:scale-105"
    >
